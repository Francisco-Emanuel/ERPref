<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            {{-- O botão de "Novo Chamado" será adicionado em outro lugar (na tela de um ativo/problema) --}}
        </div>
    </x-slot>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ativo Relacionado</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($chamados as $chamado)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $chamado->created_at->format('d/m/Y H:i') }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 text-center text-gray-500">Nenhum chamado encontrado.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
