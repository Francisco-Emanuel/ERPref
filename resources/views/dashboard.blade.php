            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#" class="bg-green-500 text-white font-bold py-3 px-5 rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                     <h3 class="text-lg font-semibold text-gray-800 mb-4">Últimos Ativos Adicionados</h3>
                     <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($ativosRecentes as $ativo)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $ativo->nome_ativo }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ativo->responsavel->name ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ativo->created_at->format('d/m/Y') }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-6 py-4 text-center text-gray-500">Nenhum ativo recente.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
