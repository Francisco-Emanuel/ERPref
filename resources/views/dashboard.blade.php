        ...
        <main class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="space-y-8">
                    ...
                    {{-- Card da Lista de Chamados Recentes --}}
                    <div class="bg-white rounded-xl shadow-sm">
                        ...
                        <div class="p-4 md:p-0">
                            @forelse ($chamadosRecentes as $chamado)
                                <div class="bg-white p-4 md:flex md:items-center md:px-6 md:py-4 border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors duration-200">
                                    <div class="flex-1">
                            ...
                            @empty
                                 <div class="p-6 text-center text-gray-500">Nenhum chamado recente para exibir.</div>
                            @endforelse
                        </div>
                    </div>
                </div>
