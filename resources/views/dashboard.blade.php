            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold {{ ($ativosDefeituosos ?? 0) > 0 ? 'text-red-500' : 'text-gray-800' }}">{{ $ativosDefeituosos ?? 0 }}</p>
                        </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between">
                        <div>
                         ...
                         <div class="bg-green-100 p-3 rounded-full">
                             <svg class="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <div class="flex flex-wrap gap-4">
                        {{-- O botão de Abrir chamado agora está protegido pela permissão --}}
                        @can('create-chamados')
                            <a href="{{ route('chamados.create') }}" class="bg-green-500 text-white font-bold py-3 px-5 rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2">
                               <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                Abrir Novo Chamado
                            </a>
                        @endcan
                        @can('create-ativos')
                            <a href="{{ route('ativos.create') }}" class="bg-blue-500 text-white font-bold py-3 px-5 rounded-lg hover:bg-blue-600 transition-colors flex items-center gap-2">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                     <h3 class="text-lg font-semibold text-gray-800 mb-4">Últimos Chamados Abertos</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Técnico Responsável</th>
                                </tr>
                            </thead>
                                ...
                                @forelse ($chamadosRecentes as $chamado)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <a href="{{ route('chamados.show', $chamado) }}" class="text-indigo-600 hover:underline">#{{ $chamado->id }}</a>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $chamado->tecnico->name ?? 'Não atribuído' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">Nenhum chamado recente.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
