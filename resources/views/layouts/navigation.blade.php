        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div x-data="{ 
                    ...
                    fetchUnreadCount: async function() { // Definida como propriedade de x-data
                        try {
                            const response = await axios.get('/api/notifications/count');
                            this.unreadCount = response.data.count; // Acessa a propriedade reativa
                        } catch (error) {
                ...
                x-init="
                    // Envolve as chamadas iniciais em um setTimeout para garantir que 'this' esteja totalmente inicializado
                    setTimeout(() => {
                        fetchUnreadCount(); // Chamada usando 'this.'
                        setInterval(() => this.fetchUnreadCount(), 30000); // Chamada usando 'this.'
                    }, 0);
                " class="relative me-4">
                    <a href="{{ route('notifications.index') }}" class="p-2 text-gray-500 hover:text-gray-700 relative focus:outline-none">
